...
public interface Partie1 {
    ...
    /**
     * sauve la configuration de l’état courant (plateau et pièces restantes) dans
     * un fichier
     * 
     * @param fileName le nom du fichier à sauvegarder
     *                 Le format doit être compatible avec celui utilisé pour la
     *                 lecture.
     */
     ...
     *               sous la forme "C6/A6/B5/D5/E6/F5" pour le coup qui place les
     *               pièces
